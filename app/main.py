...
Gestisce chiamate telefoniche in entrata tramite Twilio e Vocode
"""
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Telephony server initialized")
    logger.info(f"Webhook URL: {settings.base_url}/webhooks/twilio/voice")
